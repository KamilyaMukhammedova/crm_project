...
export type CreatedNews = Omit<IBasicModel, '_id' | 'created_date'> & { detail_image: string, preview: string };

export type EditedNews = Omit<IBasicModel, '_id' | 'created_date'> & { detail_image: string, preview: string };
