...
const vacanciesRouters = require('./routers/vacancies');
const bannersRouters = require('./routers/banners');
...
app.use(GENERAL_ROUTE_PATH, vacanciesRouters);
app.use(GENERAL_ROUTE_PATH, bannersRouters);
